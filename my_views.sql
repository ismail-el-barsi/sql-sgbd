-- Vue pour afficher tous les travailleurs présents dans toutes les usines avec leur date d'arrivée
...
-- Vue pour afficher les meilleurs fournisseurs (livré plus de 1000 pièces)
...
-- Vue pour connaître l'usine ayant assemblé chaque robot
